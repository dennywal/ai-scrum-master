...
class DocumentParser:
    ...
    def parse_tdd_document(self, content: str) -> TDDSections:
        ...
        try:
            ...
            raise DocumentParsingError("TDD", f"Unexpected parsing error: {str(e)}") from e
    ...
    def parse_prd_document(self, content: str) -> PRDSections:
        ...
        try:
            ...
            raise DocumentParsingError("PRD", f"Unexpected parsing error: {str(e)}") from e
    ...
    def _find_section(self, doc: ParsedDocument, keywords: list[str]) -> ParsedSection | None:
