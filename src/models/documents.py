...
class DocumentInput(BaseModel):
    ...
    # Document content
    tdd_content: str | None = Field(None, description="TDD document content")
    prd_content: str | None = Field(None, description="PRD document content")
    user_story_content: str | None = Field(None, description="User story content")
    ...
    # Metadata
    document_source: str | None = Field(None, description="Source of the document")
    project_context: str | None = Field(None, description="Additional project context")
    ...
    @field_validator('tdd_content', 'prd_content', 'user_story_content')
    @classmethod
...
class ParsedDocument(BaseModel):
    ...
    parsed_at: datetime = Field(default_factory=lambda: datetime.now(UTC), description="Parsing timestamp")

    def get_section_by_title(self, title: str) -> ParsedSection | None:
...
class TDDSections(BaseModel):
    ...
    overview: str | None = Field(None, description="Document overview")
...
class BriefIssueInput(BaseModel):
    ...
    initial_labels: list[str] | None = Field(None, description="Initial labels to apply")
    assignees: list[str] | None = Field(None, description="Users to assign")
    milestone: str | None = Field(None, description="Milestone to associate")

    @field_validator('brief_description')
    @classmethod
